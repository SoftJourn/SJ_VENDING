...
public class MachineServiceProd implements MachineService {
  ...
  public void buy(Integer machineId, String fieldInternalId) {
    try {
      ...
      throw new VendingProcessingException(
          "Error occurred while processing vending request. " + e.getMessage(), e);
    }
  ...
  public void resetEngines(Integer machineId) {
    try {
      ...
      throw new VendingProcessingException(
          "Error occurred while processing service request. " + e.getMessage(), e);
    }
  }
